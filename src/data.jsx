...
export const sectionOneData = [
	{
		title: 'Intoducing an extensible editor',
	...
	},
	{
		...
		text: "Flesible content management enables users to easily move through posts. Increase the usability of your blog by adding customized categories, sections, format, or flow. With this functionality, you're in full control.",
	},
]
